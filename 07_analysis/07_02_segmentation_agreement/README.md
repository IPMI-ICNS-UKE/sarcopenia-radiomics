...
| `dice_utils.py` | Per-level Dice → per-patient average → across-patient mean/SD/median/IQR. |
...
```bash
python run.py
python run_overlay.py   # after run.py
```
...
`output/07_02_segmentation_agreement/`:
